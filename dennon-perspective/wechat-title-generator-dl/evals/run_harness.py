...
def main():
    ...
    check_map = {
        "has_markdown_title": {"text": "Markdown title", "check": "has_markdown_title"},
        "has_subtitle": {"text": "Subtitle", "check": "has_subtitle"},
        "has_tags": {"text": "Tags", "check": "has_tags"},
        "no_clickbait": {"text": "No clickbait", "check": "no_clickbait"},
        "has_structure": {"text": "Structure", "check": "has_structure"},
    }
