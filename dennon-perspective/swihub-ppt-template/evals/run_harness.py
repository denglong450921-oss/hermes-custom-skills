...
def main():
    ...
    check_map = {
        ...
        "valid_pptx": {"text": "Valid PPTX", "check": "valid_pptx"},
        "gold_accent_used": {"text": "Gold accent", "check": "gold_accent_used"},
        "card_pattern": {"text": "Card pattern", "check": "card_pattern"},
        "slide_count": {"text": "Slide count", "check": "slide_count"},
    }
