...
def main():
    ...
    check_map = {
        ...
        "has_status": {"text": "Status", "check": "has_status"},
        "has_relevance_score": {"text": "Relevance", "check": "has_relevance_score"},
        "has_clarity_score": {"text": "Clarity", "check": "has_clarity_score"},
        "has_resolution": {"text": "Resolution", "check": "has_resolution"},
        "has_crop_check": {"text": "Crop check", "check": "has_crop_check"},
    }
